...
public class EmbeddedResourceHandlerTest {
    ...
    public void thatGetEmbeddedResourceNavigatesDocumentToArray() {
        createTestResource("provisionagreement", "e1", "{\"name\":\"pa-test-name\",\"contacts\":[\"/contact/c1\",\"/contact/c2\"]}");
    ...
    public void thatGETEmbeddedResourceReturnsEmptyArray() {
        createTestResource("provisionagreement", "e2", "{}");
    ...
    public void thatPutEmbeddedObjectResourceUpdatesSubDocument() {
        createTestResource("provisionagreement", "e3", "{\"name\":\"pa-test-name\",\"contacts\":[\"/contact/c1\",\"/contact/c2\"],\"address\":{\"street\":\"Der julenissen bor\",\"country\":\"Nordpolen\"}}");
        ...
        JSONAssert.assertEquals("{\"name\":\"pa-test-name\",\"contacts\":[\"/contact/c1\",\"/contact/c2\"],\"address\":{\"street\":\"Akersveien 26\",\"country\":\"Norway\"}}", response, true);
    }

    @Test
    public void thatPutEmbeddedArrayResourceUpdatesSubDocument() {
        createTestResource("provisionagreement", "e4", "{\"name\":\"pa-test-name\",\"contacts\":[\"/contact/c1\",\"/contact/c2\"]}");
        ...
        JSONAssert.assertEquals("{\"name\":\"pa-test-name\",\"contacts\":[\"/contact/truls\",\"/contact/hans\"]}", response, true);
    }

    @Test
    public void thatDeleteEmbeddedObjectResourceUpdatesSubDocument() {
        createTestResource("provisionagreement", "e5", "{\"name\":\"pa-test-name\",\"contacts\":[\"/contact/c1\",\"/contact/c2\"],\"address\":{\"street\":\"Der julenissen bor\",\"country\":\"Nordpolen\"}}");
        ...
        JSONAssert.assertEquals("{\"name\":\"pa-test-name\",\"contacts\":[\"/contact/c1\",\"/contact/c2\"]}", response, true);
    }

    @Test
    public void thatDeleteEmbeddedArrayResourceUpdatesSubDocument() {
        createTestResource("provisionagreement", "e6", "{\"name\":\"pa-test-name\",\"contacts\":[\"/contact/c1\",\"/contact/c2\"]}");
        ...
        JSONAssert.assertEquals("{\"name\":\"pa-test-name\"}", response, true);
    }

    @Test
    public void thatDELETELongResourcePathWorks() {
        createTestResource("provisionagreement", "e7", "{\"name\":\"pa-test-name\",\"support\":{\"technicalSupport\":[\"/contact/s1\",\"/contact/s2\"],\"businessSupport\":[\"/contact/b1\"]}}");
    ...
    public void thatPUTLongResourcePathWorks() {
        createTestResource("provisionagreement", "e8", "{\"name\":\"pa-test-name\",\"support\":{\"technicalSupport\":[\"/contact/s1\",\"/contact/s2\"],\"businessSupport\":[\"/contact/b1\"]}}");
