...
public class CypherQueryTransformerTest {
    ...
    @Test
    public void gsim1() {
        String cypherQuery = "MATCH (instanceVariable:InstanceVariable)\n" +
                "WHERE ALL(\n" +
